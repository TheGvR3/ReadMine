...
function LetturaDetail() {
  ...
  const getStatusStyles = (stato) => {
    ...
    switch (stato) {
      case "finito": return { text: "text-gray-500", border: "border-black", bg: "bg-gray-50" };
      case "in_corso": return { text: "text-green-600", border: "border-green-600", bg: "bg-green-50" };
      case "da_iniziare": return { text: "text-orange-600", border: "border-orange-600", bg: "bg-orange-50" };
      case "abbandonato": return { text: "text-red-600", border: "border-red-600", bg: "bg-red-50" };
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-6">
              <div className="flex-1">
                ...
                <p className="text-lg text-gray-600 font-medium italic mt-2">
                  Editore: <span className="text-indigo-600">{lettura.opere?.editore || "N/D"}</span>
                </p>
              </div>
          ...
          <div className="p-8 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100 shadow-inner">
                <p className="text-xs font-bold text-gray-400 uppercase mb-1">Stato di lettura</p>
                <p className={`text-2xl font-black uppercase ${styles.text}`}>
                  {lettura.stato ? lettura.stato.replace("_", " ") : "Non definito"}
                </p>
              </div>
              <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100 shadow-inner">
                <p className="text-xs font-bold text-gray-400 uppercase mb-1">Ultimo aggiornamento</p>
                <p className="text-2xl font-bold text-gray-800">
                  {lettura.data_lettura ? new Date(lettura.data_lettura).toLocaleDateString() : "Data non presente"}
                </p>
              </div>
            </div>
            ...
            <div className="bg-indigo-900 rounded-3xl p-8 text-white flex justify-around items-center shadow-xl">
              ...
              <div className="text-center">
                <p className="text-indigo-300 text-xs font-bold uppercase mb-1">Capitolo</p>
                <p className="text-4xl font-black">{lettura.capitolo ?? "--"}</p>
              </div>
              <div className="h-12 w-px bg-indigo-700"></div>
              <div className="text-center">
                <p className="text-indigo-300 text-xs font-bold uppercase mb-1">Pagina</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
              <div>
                ...
                <div className="flex text-3xl text-yellow-400">
                  {lettura.valutazione ? "⭐".repeat(lettura.valutazione) : <span className="text-gray-300 italic text-sm">Nessun voto</span>}
                </div>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-3">Note Personali</h3>
